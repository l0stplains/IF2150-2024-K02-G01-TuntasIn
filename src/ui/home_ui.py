...
class TaskWidget(QFrame):
    ...
    edit_clicked = pyqtSignal(int)
    delete_clicked = pyqtSignal(int)
    complete_clicked = pyqtSignal(int, bool)  # New signal
    ...
    def setup_ui(self, name, category, tags, status, due_date):
        ...
        self.update_complete_button_style()
        self.complete_btn.clicked.connect(self.toggle_completion)
    ...
    def update_complete_button_style(self):
        if self.is_complete:
    ...
    def toggle_completion(self):
        ...
        self.update_complete_button_style()
        self.complete_clicked.emit(self.task_id, self.is_complete)
